            ...
            <CardContent className="p-3">
              <div className="d-flex align-items-start">
                <div className="font-weight-bold">
                  ...
                  <span className="font-size-xxl mt-1">586</span>
                </div>
              ...
              <div className="mt-3">
                ...
                <span className="text-white-50">Pasaron el control</span>
              </div>
            </CardContent>
          </Card>
        </Grid>
            ...
            <CardContent className="p-3">
              <div className="d-flex align-items-start">
                <div className="font-weight-bold">
                  ...
                  <span className="font-size-xxl mt-1">23</span>
                </div>
                <div className="ml-auto">
              ...
              <div className="mt-3">
                ...
                />
                <span className="text-warning pr-1"></span>
                <span className="text-white-50">Aun no cruzarón el control</span>
              </div>
            </CardContent>
          </Card>
        </Grid>
            ...
            <CardContent className="p-3">
              <div className="d-flex align-items-start">
                <div className="font-weight-bold">
                  ...
                  <span className="font-size-xxl mt-1">609</span>
                </div>
                <div className="ml-auto">
                  <div className="bg-white text-center text-primary d-50 rounded-circle d-flex align-items-center justify-content-center">
                    <FontAwesomeIcon
              ...
              <div className="mt-3">
                ...
                <span className="text-white-50">Total tornaguias emitidas</span>
              </div>
            </CardContent>
          </Card>
        </Grid>
            ...
            <CardContent className="p-0">
              ...
              <div className="text-center py-4">
                <Button size="small" color="primary">
                  ...
                  <span className="btn-wrapper--label">Generar Reportes</span>
                </Button>
              </div>
            </CardContent>
