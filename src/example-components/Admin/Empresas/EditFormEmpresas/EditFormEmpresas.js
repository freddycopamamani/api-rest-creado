...
import { getEmpresaByIdApi, updateEmpresaApi } from '../../../../api/empresa';
...
const EditFormEmpresas = (props) => {
  ...
  useEffect(() => {
    const getEmpresa = () => {
      getEmpresaByIdApi(id)
        .then(response => {
          setValues(response.EmpresaById)  
        })
      }
  ...
  return (
    <>
      <ExampleWrapperSeamless sectionHeading="Editar empresa" />
...
export default withRouter(EditFormEmpresas);
